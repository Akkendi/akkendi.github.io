...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
        ...
        const townsArray = towns.filter(towns => (towns.name == 'Fish Haven'))
    ...
    const weatherURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&APPID=dc3ca0b1e530db7c8b79a01f0377b48e";
fetch(weatherURL)
...
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=dc3ca0b1e530db7c8b79a01f0377b48e";
fetch(forecastURL)
    .then((response) => response.json())
    .then((jsObject) => {
        console.log(jsObject);
